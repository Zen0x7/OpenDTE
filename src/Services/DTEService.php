...
class DTEService
{
     ...
     */
    public static function DTE($firma, $folios, $caratula, $documentos, $previsualizar = false)
    {
     ...
     */
    public static function generar_pdf($envioDTE, $logoUrl, $logoIzquierda = 1, $pdfName, $papelContinuo = 0)
    {
    ...
    public static function generar_documento($firma, $folios, $caratula, $documento, $logoUrl, $query)
    {
        ...
        if ($previsualizar) {
            ...
            $Pdf = DTEService::generar_pdf($EnvioDTE, $logoUrl, $logo_izquierda, $pdf_name, $papelContinuo);
     ...
     */
    public static function enviar_libro_guia($firma, $caratula, $documento)
    {
    ...
    public static function enviar_libro_compra_venta($firma, $caratula, $archivoParseado, $tipoOperacion, $query)
    {
        ...
        if ($tipoOperacion === static::LIBRO_COMPRA) {
            $LibroCompraVenta->agregarComprasArray($archivoParseado);
        } elseif ($tipoOperacion === static::LIBRO_VENTA) {
